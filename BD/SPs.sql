...
--4
alter PROCEDURE SP_MAYORES_COMPRAS
@AÑO INT = 2024,
@CONTACTO VARCHAR = '%',
@CANTIDAD INT = 1
AS
...
alter PROCEDURE SP_REPORTE_MENSUAL_COBERTURA
@ANIO INT,
@MES INT,
@obra_social INT
AS
...
END
 ...
 exec SP_REPORTE_MENSUAL_COBERTURA @ANIO=2024, @MES=8, @obra_social = 1 --prueba
...
exec SP_REPORTE_MENSUAL_OBRA_SOCIAL @ANIO=2024, @MES=8, @obra_social = 1 